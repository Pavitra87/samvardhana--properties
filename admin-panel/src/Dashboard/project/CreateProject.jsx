...
const CreateProject = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      const response = await axios.post(
        "https://samvardhana-properties.onrender.com/api/project/",
        data,
        {
      ...
      navigate("/projectdashboard"); // <-- Adjust this path to your dashboard route
    } catch (error) {
  ...
  const handleClose = () => {
    navigate("/projectdashboard"); // Go back to blog dashboard
  };
  return (
