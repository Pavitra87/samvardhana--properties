...
const ProjectDashboard = () => {
    ...
    setLoading(true);
    try {
      const res = await axios.get("https://samvardhana-properties.onrender.com/api/project/");
  ...
  const handleDelete = async (id) => {
    ...
    try {
      await axios.delete(`https://samvardhana-properties.onrender.com/api/project/${id}`);
                ...
                <tbody>
                  {projects.map((project, index) => (
                    <tr key={project._id} className="hover:bg-gray-50">
                      ...
                      <td className="p-2 border">{project.heading}</td>
